...
public extension TwifterClient {
     ...
     */
    func geo_id(place_id: String) async throws -> [String: Any] {
     ...
     */
    func geo_reverse_geocode(lat: Double, long: Double, accuracy: Int? = nil, granularity: Granularity? = nil, max_results: Int? = nil) async throws -> [String: Any] {
        let guest_token = try await generate_guest_token().guest_token
     ...
     */
    func geo_search(query: String, granularity: Granularity? = nil, accuracy: Int? = nil, max_results: Int? = nil, contained_within: String? = nil, attribute_street_address: String? = nil) async throws -> [String: Any] {
        let guest_token = try await generate_guest_token().guest_token
    ...
    /**
     ...
     https://developer.twitter.com/en/docs/twitter-api/v1/geo/places-near-location/api-reference/get-geo-search
     */
    func geo_search(lat: Double, long: Double, granularity: Granularity? = nil, accuracy: Int? = nil, max_results: Int? = nil, contained_within: String? = nil, attribute_street_address: String? = nil) async throws -> [String: Any] {
        let guest_token = try await generate_guest_token().guest_token
    ...
    /**
     ...
     https://developer.twitter.com/en/docs/twitter-api/v1/geo/places-near-location/api-reference/get-geo-search
     */
    func geo_search(ip: String, granularity: Granularity? = nil, accuracy: Int? = nil, max_results: Int? = nil, contained_within: String? = nil, attribute_street_address: String? = nil) async throws -> [String: Any] {
        let guest_token = try await generate_guest_token().guest_token
