...
public extension TwifterClient {
     ...
     */
    func favorites_list(user_id: String, count: Int? = nil, since_id: Int? = nil, max_id: Int? = nil, include_entities: Bool? = nil, tweet_mode: TweetMode? = nil) async throws -> [[String: Any]] {
    ...
    /**
     ...
     https://developer.twitter.com/en/docs/twitter-api/v1/tweets/post-and-engage/api-reference/get-favorites-list
     */
    func favorites_list(screen_name: String, count: Int? = nil, since_id: Int? = nil, max_id: Int? = nil, include_entities: Bool? = nil, tweet_mode: TweetMode? = nil) async throws -> [[String: Any]] {
        let guest_token = try await generate_guest_token().guest_token
