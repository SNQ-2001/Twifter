...
public extension TwifterClient {
     ...
     */
    func statuses_retweeters_ids(id: Int, cursor: String? = nil, stringify_ids: Bool? = nil) async throws -> [String: Any] {
        let guest_token = try await generate_guest_token().guest_token
     ...
     */
    func statuses_retweets(id: Int, count: Int? = nil, trim_user: Bool? = nil) async throws -> [[String: Any]] {
        let guest_token = try await generate_guest_token().guest_token
