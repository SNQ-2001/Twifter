...
public extension TwifterClient {
     ...
     */
    func friendships_show(source_id: Int, target_id: Int) async throws -> [String: Any] {
    ...
    /**
     ...
     https://developer.twitter.com/en/docs/twitter-api/v1/accounts-and-users/follow-search-get-users/api-reference/get-friendships-show
     */
    func friendships_show(source_screen_name: String, target_screen_name: String) async throws -> [String: Any] {
        let guest_token = try await generate_guest_token().guest_token
