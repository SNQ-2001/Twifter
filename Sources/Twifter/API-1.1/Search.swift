...
public extension Client {
     ...
     */
    public func search_tweets(q: String, geocode: String? = nil, lang: Languages? = nil, locale: Locale? = nil, result_type: Result_Type? = nil, count: Int? = nil, until: (year: Int, month: Int, day: Int)? = nil, since_id: Int? = nil, max_id: Int? = nil, include_entities: Bool? = nil) async throws -> [String: Any] {
