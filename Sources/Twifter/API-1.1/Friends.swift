...
public extension TwifterClient {
     ...
     */
    func friends_ids(user_id: Int, cursor: String? = nil, stringify_ids: Bool? = nil, count: Int? = nil) async throws -> [String: Any] {
    ...
    /**
     ...
     https://developer.twitter.com/en/docs/twitter-api/v1/accounts-and-users/follow-search-get-users/api-reference/get-friends-ids
     */
    func friends_ids(screen_name: String, cursor: String? = nil, stringify_ids: Bool? = nil, count: Int? = nil) async throws -> [String: Any] {
        let guest_token = try await generate_guest_token().guest_token
