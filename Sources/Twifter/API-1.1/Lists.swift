...
public extension TwifterClient {
    ...
    /**
     ...
     https://developer.twitter.com/en/docs/twitter-api/v1/accounts-and-users/create-manage-lists/api-reference/get-lists-list
     */
    func lists_list(screen_name: String, reverse: Bool? = nil) async throws -> [[String: Any]] {
        let guest_token = try await generate_guest_token().guest_token
     ...
     */
    func lists_memberships(user_id: Int, count: Int? = nil, cursor: String? = nil) async throws -> [String: Any] {
        let guest_token = try await generate_guest_token().guest_token
    ...
    /**
     ...
     https://developer.twitter.com/en/docs/twitter-api/v1/accounts-and-users/create-manage-lists/api-reference/get-lists-memberships
     */
    func lists_memberships(screen_name: String, count: Int? = nil, cursor: String? = nil) async throws -> [String: Any] {
        let guest_token = try await generate_guest_token().guest_token
     ...
     */
    func lists_ownerships(user_id: Int, count: Int? = nil, cursor: String? = nil) async throws -> [String: Any] {
        let guest_token = try await generate_guest_token().guest_token
    ...
    /**
     ...
     https://developer.twitter.com/en/docs/twitter-api/v1/accounts-and-users/create-manage-lists/api-reference/get-lists-ownerships
     */
    func lists_ownerships(screen_name: String, count: Int? = nil, cursor: String? = nil) async throws -> [String: Any] {
        let guest_token = try await generate_guest_token().guest_token
     ...
     */
    func lists_show(list_id: Int) async throws -> [String: Any] {
        let guest_token = try await generate_guest_token().guest_token
     ...
     */
    func lists_subscribers(list_id: Int, count: Int? = nil, cursor: String? = nil, include_entities: Bool? = nil, skip_status: Bool? = nil) async throws -> [String: Any] {
        let guest_token = try await generate_guest_token().guest_token
     ...
     */
    func lists_subscriptions(user_id: Int, count: Int? = nil, cursor: String? = nil) async throws -> [String: Any] {
        let guest_token = try await generate_guest_token().guest_token
    ...
    /**
     ...
     https://developer.twitter.com/en/docs/twitter-api/v1/accounts-and-users/create-manage-lists/api-reference/get-lists-subscriptions
     */
    func lists_subscriptions(screen_name: String, count: Int? = nil, cursor: String? = nil) async throws -> [String: Any] {
        let guest_token = try await generate_guest_token().guest_token
